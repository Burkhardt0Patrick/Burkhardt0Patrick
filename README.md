...
Sou apaixonado por tecnologia, segurança digital e desenvolvimento.  
Atualmente estou me aprofundando em:

- ☕ Java moderno para desenvolvimento backend e aplicações robustas  
- 🐍 Python para automação, scripts de segurança e ferramentas ofensivas  
- 🌐 HTML, CSS, JavaScript e Git para controle de versão e aplicações web  
- 🧪 Projetos integrando desenvolvimento com cibersegurança    
...
- 🧠 Estudando projetos práticos e desafios em desenvolvimento + segurança ofensiva
